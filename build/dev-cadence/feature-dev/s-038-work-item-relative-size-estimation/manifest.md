...
- Branch: `codex/s-038-work-item-relative-size-estimation`
...
| Implementation Plan | `in_progress` | `build/dev-cadence/feature-dev/s-038-work-item-relative-size-estimation/03-implementation-plan.md` | `pending` | `pending` | Test-first implementation plan in progress. |
...
- Size must remain a relative planning signal and must not be interpreted as duration, person-days, or capacity.
- The baseline-card lifecycle and cross-asset synchronization require Technical Solution confirmation before implementation planning.
