...
| --- | --- | --- | --- | --- | --- |
| Problem Diagnosis | 🔄 `in_progress` | [B-014 问题诊断记录](01-problem-diagnosis-record.md); path: `build/dev-cadence/bug-fix/b-014-single-card-intake-duplicate-confirmation-gates/01-problem-diagnosis-record.md` | ⏳ `pending` | `92d454c` | 根因调查完成，等待用户确认 |
| Repair Solution | ⏳ `pending` | ⏳ `pending`: `build/dev-cadence/bug-fix/b-014-single-card-intake-duplicate-confirmation-gates/02-repair-solution.md` | ⏳ `pending` | ⏳ `pending` | 等待问题诊断确认 |
