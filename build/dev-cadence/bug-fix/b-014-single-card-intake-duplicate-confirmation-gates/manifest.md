...
| Repair Solution | 🔄 `in_progress` | [B-014 修复方案](02-repair-solution.md); path: `build/dev-cadence/bug-fix/b-014-single-card-intake-duplicate-confirmation-gates/02-repair-solution.md` | ⏳ `pending` | ⏳ `pending` | 方案已形成，等待用户确认 |
