...
| Repair Solution | 🔄 `in_progress` | [B-010 修复方案](02-repair-solution.md); path: `build/dev-cadence/bug-fix/b-010-generated-record-document-links-not-enforced/02-repair-solution.md` | ⏳ `pending` | ⏳ `pending` | 方案已形成，等待用户确认 |
