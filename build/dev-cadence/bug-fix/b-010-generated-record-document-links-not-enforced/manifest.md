...
| --- | --- | --- | --- | --- | --- |
| Problem Diagnosis | 🔄 `in_progress` | [B-010 问题诊断记录](01-problem-diagnosis-record.md); path: `build/dev-cadence/bug-fix/b-010-generated-record-document-links-not-enforced/01-problem-diagnosis-record.md` | ⏳ `pending` | ⏳ `pending` | 根因调查完成，等待用户确认 |
| Repair Solution | ⏳ `pending` | ⏳ `pending`: `build/dev-cadence/bug-fix/b-010-generated-record-document-links-not-enforced/02-repair-solution.md` | ⏳ `pending` | ⏳ `pending` | 等待问题诊断确认 |
| Repair Plan | ⏳ `pending` | ⏳ `pending`: `build/dev-cadence/bug-fix/b-010-generated-record-document-links-not-enforced/03-repair-plan.md` | ⏳ `pending` | ⏳ `pending` | 等待修复方案确认 |
