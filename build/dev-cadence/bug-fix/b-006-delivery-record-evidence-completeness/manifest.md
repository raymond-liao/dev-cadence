...
| Repair Plan | `in_progress` | [修复计划](03-repair-plan.md) (`build/dev-cadence/bug-fix/b-006-delivery-record-evidence-completeness/03-repair-plan.md`) | pending | `pending` | 已在隔离 worktree；计划采用测试先行并保持三套 Workflow 对称。 |
