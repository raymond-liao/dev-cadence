...
| 4 | 2026-07-20T17:52:10+0800 | Raymond Liao <raymond-liao@outlook.com> | 将 Story 状态更新为 `Done`，并记录已验收的本地集成交付。 | 用户在 Business Acceptance 选择 `1. Accept`；S-029 已合并到 `main` 且合并后完整验证通过。 |
