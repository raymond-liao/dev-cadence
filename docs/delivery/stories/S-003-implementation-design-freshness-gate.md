...
|---:|---|---|---|---|
| 1 | legacy: recorded-at precision unknown; original 2026-07-14 | legacy: recorded-by unknown | 创建实施前方案新鲜度门禁 Story。 | 防止开发 workflow 根据已经被需求、决策或代码现实淘汰的方案继续实施。 |
| 1 | legacy: recorded-at precision unknown; original 2026-07-14 | legacy: recorded-by unknown | 完成实施前方案新鲜度门禁并通过业务验收。 | 三个 Delivery workflow、对称契约和安装包已验证完成。 Legacy migration: original Version 2; normalized to Version 1. |
| 1 | 2026-07-19T13:07:24+0800 | Raymond Liao <raymond-liao@outlook.com> | Normalized legacy status and delivery events to reuse the active definition Version. | Old current 2 -> new current 1; original row versions 1,2 -> normalized row versions 1,1. |
