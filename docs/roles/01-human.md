...
- 写入 [01-requirements.md](../artifacts/01-requirements.md) 的需求决策。
- 写入 [02-design.md](../artifacts/02-design.md) 或 ADR 的架构决策。
- 写入 [permission-decisions.md](../runs/07-permission-decisions.md) 的权限决策。
- merge、release 或 final acceptance decisions。
