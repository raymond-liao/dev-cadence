...
| ID | Title | Version | Status | Priority |
|---|---|---:|---|---|
| `S-017` | [工作项卡片与开发 Workflow 接入](stories/S-017-work-item-development-workflow-integration.md) | `3` | `Ready` | `P1` |
...
| `B-005` | [已安装 Workflow 用户确认门摘要、选项与结果语义不完整](bugs/B-005-refactor-confirmation-options-missing.md) | `3` | `Draft` | `P1` |
| `B-007` | [当前可并行实施表混用卡片状态与流程入口资格](bugs/B-007-parallel-work-table-entry-qualification.md) | `1` | `Draft` | `P1` |
...
| `B-003` | [Refactor 公共契约兼容性](bugs/B-003-refactor-public-contract-compatibility.md) | `1` | `Done` | `P1` |
...
| 6 | [S-017](stories/S-017-work-item-development-workflow-integration.md) | [S-015](stories/S-015-work-item-planning-workflow-contract.md)、[S-016](stories/S-016-unified-backlog-board.md)、[S-037](stories/S-037-work-item-analysis-workflow.md) | ✅ Ready | Story 需保持 `Ready` 后进入 feature-dev；仍需用户授权。 |
| 7 | [S-029](stories/S-029-feature-persistent-record-contract.md) | [S-017](stories/S-017-work-item-development-workflow-integration.md) | ⚠️ Blocked | Story 需保持 `Ready` 且满足 S-017 依赖后进入 feature-dev。 |
| 8 | [S-018](stories/S-018-business-acceptance-terminal-mapping.md)；[S-019](stories/S-019-final-verification-revision-binding.md)；[S-020](stories/S-020-implementation-review-risk-to-verification.md)；[S-021](stories/S-021-verification-risk-to-business-acceptance.md) | - | Draft | Story 各自达到 `Ready` 后进入 feature-dev；不得自动启动。 |
| 9 | [S-024](stories/S-024-bug-diagnosis-gate.md) | - | Draft | Story 达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
| 10 | [S-022](stories/S-022-bug-not-a-bug-terminal-state.md)；[S-025](stories/S-025-bug-red-green-evidence.md) | - | Draft | Story 各自达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
| 11 | [S-026](stories/S-026-refactor-baseline-identity.md)；[S-027](stories/S-027-refactor-migration-start-contract.md) | - | Draft | Story 各自达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
| 12 | [S-028](stories/S-028-refactor-legacy-path-removal-gate.md) | [S-027](stories/S-027-refactor-migration-start-contract.md) | ⚠️ Blocked | Story 达到 `Ready` 且满足 S-027 依赖后进入 feature-dev。 |
| 13 | [S-023](stories/S-023-manual-recovery-terminal-state.md) | - | Draft | Story 达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
| 14 | [S-038](stories/S-038-work-item-relative-size-estimation.md) | [S-015](stories/S-015-work-item-planning-workflow-contract.md) | ✅ Ready | Story 已为 `Ready`，经用户授权后进入 feature-dev。 |
| 15 | [S-039](stories/S-039-iteration-plan-capacity-calibration.md) | [S-016](stories/S-016-unified-backlog-board.md)、[S-038](stories/S-038-work-item-relative-size-estimation.md) | ⚠️ Blocked | Story 达到 `Ready` 且依赖满足后进入 feature-dev。 |
| 16 | [T-002](tasks/T-002-requirements-governance-end-to-end-validation.md) | [S-004](stories/S-004-failure-classification-stage-routing.md)、[S-015](stories/S-015-work-item-planning-workflow-contract.md)、[S-016](stories/S-016-unified-backlog-board.md)、[S-017](stories/S-017-work-item-development-workflow-integration.md)、[S-037](stories/S-037-work-item-analysis-workflow.md)、[S-038](stories/S-038-work-item-relative-size-estimation.md)、[S-039](stories/S-039-iteration-plan-capacity-calibration.md) | ⚠️ Blocked | Task 按已确认目标进入 feature-dev / bug-fix / refactor；对应 Workflow 确认范围后才可修改代码。 |
| 17 | [S-030](stories/S-030-worktree-ownership-detection.md) | - | Draft | Story 达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
| 18 | [S-031](stories/S-031-preserve-worktree-run-records.md) | [S-030](stories/S-030-worktree-ownership-detection.md) | ⚠️ Blocked | Story 达到 `Ready` 且满足 S-030 依赖后进入 feature-dev。 |
| 19 | [S-032](stories/S-032-detached-head-finishing.md) | - | Draft | Story 达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
| 20 | [S-033](stories/S-033-worktree-cleanup-result-recording.md) | [S-030](stories/S-030-worktree-ownership-detection.md)、[S-031](stories/S-031-preserve-worktree-run-records.md) | ⚠️ Blocked | Story 达到 `Ready` 且满足依赖后进入 feature-dev。 |
| 21 | [S-034](stories/S-034-release-and-production-delivery-capability.md) | - | Draft | Story 达到 `Ready` 后进入 feature-dev；当前 Draft 仍需分析和确认。 |
