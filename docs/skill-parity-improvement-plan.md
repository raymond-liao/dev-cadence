...
| [ ] | `cadence-review` | `receiving-code-review` | ❌ | 部分补强 | 已补 verify-before-implement、禁止表演式同意、unclear feedback 停手、source-specific handling、pushback、逐项处理、GitHub thread reply 和 re-review handoff；仍需按文件级结构和行为触发力再次确认。 |
