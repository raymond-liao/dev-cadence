...
When the user asks for product discovery, product ideas, architecture design, requirements work, development work, active-task follow-up, testing, verification, or commit/checkpoint operations, check Dev Cadence before any repository exploration, product-design or architecture changes, implementation, Git mutation, or clarifying question:
