...
required_files=(
  ...
  "dist/.dev-cadence/workflows/backlog/SKILL.md"
...
assert_match "docs/delivery/open-questions.md" "src/skills/open-question-registry/SKILL.md"
assert_match "docs/delivery/backlog.md" "src/workflows/backlog/SKILL.md"
assert_match 'Story.*eligible for `feature-dev`.*Status.*`Ready`' "src/workflows/backlog/SKILL.md"
assert_match 'Bug may enter `bug-fix` without `Ready`' "src/workflows/backlog/SKILL.md"
...
test ! -e "$DIST_DIR/workflows/discovery" || fail "package retained removed discovery workflow"
test ! -e "$DIST_DIR/workflows/work-item-planning" || fail "package retained removed work-item-planning workflow"
