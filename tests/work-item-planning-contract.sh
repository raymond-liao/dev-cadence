...
assert_literal "backlog no parallel table reorder" 'Do not modify the sorting or row order of the `当前可并行实施表` when updating Backlog lifecycle sections.' "$SKILL"
