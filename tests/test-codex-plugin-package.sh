...
assert_exists "skills/cadence-research/SKILL.md"
assert_exists "skills/cadence-executing-plans/SKILL.md"
assert_exists "skills/cadence-subagent-development/SKILL.md"
assert_exists "skills/cadence-dispatch-parallel/SKILL.md"
...
assert_absent "references/root-cause-tracing.md"
assert_absent "references/condition-based-waiting.md"
assert_absent "references/defense-in-depth.md"
assert_exists "references/source-maintenance/authoring-discipline.md"
assert_exists "references/source-maintenance/skill-pressure-testing.md"
...
assert_absent "templates/prompts"
...
assert_exists "scripts/target-repo-contract.mjs"
assert_exists "scripts/package-codex-plugin.mjs"
assert_exists "scripts/package-target-repo-bundle.mjs"
assert_exists "scripts/sync-target-repo-bundle.mjs"
