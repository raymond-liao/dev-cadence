...
assert_match "PRD and Business Architecture increment rules" 'PRD and Business Architecture versions are independent.*increment only the affected document' "$DISCOVERY_SKILL"
