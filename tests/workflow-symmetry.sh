...
assert_match "entry refactor flow" "\\.dev-cadence/workflows/refactor/SKILL\\.md" "$ENTRY_SKILL"
...
assert_match "installed pre-response gate" "Before responding to or acting on requests" "$AGENTS_SNIPPET"
assert_match "installed entry read-and-follow rule" "read and follow" "$AGENTS_SNIPPET"
assert_match "installed user-facing guidance gate" "user-facing guidance" "$AGENTS_SNIPPET"
assert_match "installed shared capability routing" "workflow, shared capability, or ordinary handling" "$AGENTS_SNIPPET"
...
assert_workflows "installed validator path" "\\.dev-cadence/workflows/using-dev-cadence/scripts/validate-delivery-record\\.sh" "\\.dev-cadence/workflows/using-dev-cadence/scripts/validate-delivery-record\\.sh" "\\.dev-cadence/workflows/using-dev-cadence/scripts/validate-delivery-record\\.sh"
...
assert_workflows "work item card integration section" "## Work Item Card Integration" "## Work Item Card Integration" "## Work Item Card Integration"
assert_workflows "work item exact card path" "exact card path" "exact card path" "exact card path"
assert_workflows "work item current Version" "current card Version" "current card Version" "current card Version"
assert_workflows "work item selected scope" "selected scope" "selected scope" "selected scope"
assert_workflows "work item visible fact conflict" "visible-fact conflict" "visible-fact conflict" "visible-fact conflict"
assert_workflows "work item idempotent writeback" "idempotent" "idempotent" "idempotent"
assert_workflows "work item no false Done" "must not mark the card.*Done" "must not mark the card.*Done" "must not mark the card.*Done"
...
assert_workflows "terminal validator invocation" "bash \\.dev-cadence/workflows/using-dev-cadence/scripts/validate-delivery-record\\.sh[[:space:]]+build/dev-cadence/feature-dev/<feature-slug> --terminal" "bash \\.dev-cadence/workflows/using-dev-cadence/scripts/validate-delivery-record\\.sh[[:space:]]+build/dev-cadence/bug-fix/<bug-slug> --terminal" "bash \\.dev-cadence/workflows/using-dev-cadence/scripts/validate-delivery-record\\.sh[[:space:]]+build/dev-cadence/refactor/<refactor-slug> --terminal"
